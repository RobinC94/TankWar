...
CRB_TANK::Bullet::Bullet()
{
}

CRB_TANK::Bullet::Bullet(Point pos, Dir dir, COLORREF color)
{
	m_pos = pos;
	m_dir = dir;
	m_color = color;
...
void CRB_TANK::Bullet::Boom(list<Object*>& lstBombs)
{
	lstBombs.push_back(new Bomb(m_pos, SMALL));
}

void CRB_TANK::Bullet::CalculateSphere()
{
