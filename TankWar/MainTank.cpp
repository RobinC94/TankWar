...
void CRB_TANK::MainTank::SetDir(Dir dir)
{
	m_dir = dir;
}

void CRB_TANK::MainTank::Display()
{
...
void CRB_TANK::MainTank::Shoot(list<Object*>& lstBullets)
{
...
void CRB_TANK::MainTank::Boom(list<Object*>& lstBombs)
{
}



void CRB_TANK::MainTank::CalculateSphere()
{
	switch (m_dir)
	{
	case UP:
...
void CRB_TANK::MainTank::DrawTankBody()
{
